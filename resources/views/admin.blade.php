...
<nav>
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <button class="nav-link" id="nav-install-tab" data-bs-toggle="tab" data-bs-target="#nav-install" type="button" role="tab" aria-controls="nav-install" aria-selected="false">Установки</button>
...
<div class="container">
  ...
  <div class="tab-content" id="nav-tabContent">
    ...
    <div class="tab-pane fade" id="nav-addts" role="tabpanel" aria-labelledby="nav-exit-tab"><addtask-component> </addtask-component></div>
